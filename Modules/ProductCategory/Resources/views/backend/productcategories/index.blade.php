                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("productcategory::text.name")
                            </th>
                            <th>
                                @lang("productcategory::text.slug")
                            </th>
                            <th>
                                @lang("productcategory::text.updated_at")
                            </th>
                            <th>
                                @lang("productcategory::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("productcategory::text.action")
                            </th>
                        </tr>
                    </thead>
